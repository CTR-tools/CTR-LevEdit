...
namespace CTRFramework
{
    public class VisData : IReadWrite
    {
        ...
        public VisInstance visInstance;
        ...
        public override string ToString()
        {
            ...
            {
                return
                    $"id = {id} | flag = {flag} | ptr = {ptrQuadBlock.ToString("X8")}\r\n\t{bbox.ToString()}\r\n leftChild = {leftChild} | rightChild = {rightChild}\r\n\t";
            }
            else
            {
                return
                    $"id = {id} | flag = {flag} | ptr = {ptrQuadBlock.ToString("X8")}\r\n\t{bbox.ToString()}\r\n u1 = {u1} | ptrUnkData = {ptrUnkData}\r\n numQuadBlock = {numQuadBlock} | ptrQuadBlock = {ptrQuadBlock}\r\n\t";
