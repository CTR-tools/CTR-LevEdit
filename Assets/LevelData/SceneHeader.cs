...
namespace CTRFramework
{
    public class SceneHeader : IReadWrite
    {
        ...
        private string compilationBeginsStr, compilationEndsStr, ptrBuildTypeStr;
        public SceneHeader()
        {
        }
        ...
        public void Read(BinaryReaderEx br)
        {
            ...
            compilationBeginsStr = br.ReadStringNT();
            //compilationBegins = Helpers.ParseDate(compilationBeginsStr);

            br.Jump(ptrBuildEnd);
            compilationEndsStr = br.ReadStringNT();
            //compilationEnds = Helpers.ParseDate(compilationEndsStr);

            br.Jump(ptrBuildType);
            ptrBuildTypeStr = br.ReadStringNT();
            Console.WriteLine(ptrBuildTypeStr);
